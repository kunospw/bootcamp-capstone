                ...
                <div className="relative pt-16">
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-lg text-blue-100">Jobs you've saved for later review</p>
                        </div>
                        ...
                        <div className="bg-white rounded-lg shadow-lg border border-gray-200 relative z-10">
                            <div className="p-6">
                                            ...
                                            <div className="p-6 flex flex-col flex-1">
                                                ...
                                                <div className="flex items-start space-x-4 mb-4 min-h-[4rem]">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <p className="text-gray-600 text-sm">{savedJob.jobId.companyId?.companyName}</p>
                                                    </div>
                                                    <button
                                ...
                                <div className="text-center mt-6 text-sm text-gray-500">
                                    Showing {Math.min(displayCount, savedJobs.length)} of {savedJobs.length} saved jobs
                                </div>
                            </div>
                        </div>
                    )}
